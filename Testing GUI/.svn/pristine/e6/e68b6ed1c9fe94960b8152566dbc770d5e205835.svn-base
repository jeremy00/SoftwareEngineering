...
public class frame extends JFrame implements CheckersClient{
...
//			this.setTitle("Checkers Client - Lobby");
//			getContentPane().setBackground(new java.awt.Color(100,100,100));
//			getContentPane().setBackground(new java.awt.Color(235,233,237));
//			getContentPane().add(getChatPane(), new AnchorConstraint(5, 175, 46, 6, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS));
//			getContentPane().add(getSubmitPanel(), new AnchorConstraint(809, 175, 6, 6, AnchorConstraint.ANCHOR_NONE, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS));
//			getContentPane().add(getJTabbedPane(), new AnchorConstraint(5, 6, 63, 685, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_NONE));
//			//getContentPane().add(getNewCheckersTblButton(), new AnchorConstraint(897, 80, 5, 688, AnchorConstraint.ANCHOR_NONE, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_NONE));
...
//			AnchorLayout submitPanelLayout = new AnchorLayout();
//			submitPanel.setLayout(submitPanelLayout);
//			submitPanel.setPreferredSize(new java.awt.Dimension(456, 33));
//			submitPanel.add(getChatInputField(), new AnchorConstraint(0, 67, 0, 0, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS));
//			submitPanel.add(getSubmitButton(), new AnchorConstraint(-1, 0, -1, 839, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_ABS, AnchorConstraint.ANCHOR_NONE));
//			submitPanel.setPreferredSize(new java.awt.Dimension(456, 29));
//		}
//		return submitPanel;
//	}
